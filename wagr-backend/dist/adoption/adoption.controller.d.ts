...
export declare class AdoptionController {
    ...
    createAdoptionProfile(req: any, dogId: string, createAdoptionProfileDto: CreateAdoptionProfileDto): Promise<{
        dog: {
            owner: {
                firstName: string;
                lastName: string;
    ...
    updateAdoptionProfile(req: any, id: string, updateAdoptionProfileDto: UpdateAdoptionProfileDto): Promise<{
        dog: {
            owner: {
                firstName: string;
                lastName: string;
    ...
    createAdoptionApplication(req: any, adoptionProfileId: string, body: {
        message?: string;
    }): Promise<{
        adoptionProfile: {
            dog: {
    ...
    getAdoptionApplications(req: any): Promise<({
        adoptionProfile: {
            dog: {
                owner: {
                    firstName: string;
    ...
    updateAdoptionApplicationStatus(req: any, applicationId: string, body: {
        status: string;
    }): Promise<{
        adoptionProfile: {
            dog: {
